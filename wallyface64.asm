...
;fix labels with subroutine command
;--------------------------------------------------------------
...
; draw player sprite 0:
	...
	bcs     .doDraw_E1_bb        ; 2/3 ; should be bcs
	lda     #0              ; 2
	.byte   $2c             ;-1 (BIT ABS to skip next 2 bytes)(kinda like a jump)
.doDraw_E1_bb:
	lda     (E1_Ptr),y      ; 5
...
; draw player sprite 0:
	lda     #C_P0_HEIGHT-1     ; 2
	dcp     E1_Y            ; 5 (DEC and CMP)
	bcs     .doDraw_A       ; 2/3 ; should be bcs
	lda     #0              ; 2
...
; draw Hero sprite:
	lda     #C_P1_HEIGHT-1     ; 2 
	dcp     Hero_Y            ; 5 (DEC and CMP)                                                                                                                                                                                                                                                                               
	bcs     .doDraw_B       ; 2/3 ; should be bcs
	lda     #0              ; 2
	.byte   $2c             ;-1 (BIT ABS to skip next 2 bytes)(kinda like a jump)
.doDraw_B:
	lda     (Hero_Ptr),y      ; 5
...
; draw Hero sprite:
	lda     #C_P1_HEIGHT-1     ; 2 
	dcp     Hero_Y            ; 5 (DEC and CMP)
	bcs     .doDraw_C        ; 2/3 ; should be bcs
	lda     #0              ; 2
	.byte   $2c             ;-1 (BIT ABS to skip next 2 bytes)(kinda like a jump)
.doDraw_C:
	lda     (Hero_Ptr),y      ; 5
...
; draw Hero sprite:
	lda     #C_P1_HEIGHT-1     ; 2 
	dcp     Hero_Y            ; 5 (DEC and CMP)
	bcs     .doDraw_D        ; 2/3 ; should be bcs
	lda     #0              ; 2
;	sta Graphics_Buffer
	.byte   $2c             ;-1 (BIT ABS to skip next 2 bytes)(kinda like a jump)
.doDraw_D:
...
; draw Hero sprite:
	lda     #C_P1_HEIGHT-1     ; 2 
	dcp     Hero_Y            ; 5 (DEC and CMP)                                                                                                                                                                                                                                                                               
	bcs     .doDraw_F       ; 2/3 ; should be bcs
	lda     #0              ; 2
	.byte   $2c             ;-1 (BIT ABS to skip next 2 bytes)(kinda like a jump)
.doDraw_F:
	lda     (Hero_Ptr),y      ; 5
...
; draw player sprite 0:
	...
	bcs     .doDraw_G        ; 2/3 ; should be bcs
	lda     #0              ; 2
	.byte   $2c             ;-1 (BIT ABS to skip next 2 bytes)(kinda like a jump)
.doDraw_G:
	lda     (E2_Ptr),y      ; 5
...
; draw Hero sprite:
	lda     #C_P1_HEIGHT-1     ; 2 
	dcp     Hero_Y            ; 5 (DEC and CMP)                                                                                                                                                                                                                                                                               
	bcs     .doDraw_H       ; 2/3 ; should be bcs
	lda     #0              ; 2
	.byte   $2c             ;-1 (BIT ABS to skip next 2 bytes)(kinda like a jump)
.doDraw_H:
	lda     (Hero_Ptr),y      ; 5
